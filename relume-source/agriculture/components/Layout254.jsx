        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Agricultural scenarios we structure for
            </h2>
            <p className="md:text-md">
              If one of these sounds familiar, this page is for you.
            </p>
          </div>
        </div>
        <div className="grid place-items-center gap-x-8 gap-y-12 sm:grid-cols-2 md:gap-y-16 lg:grid-cols-[1fr_1.5fr_1fr] lg:gap-x-12">
          <div className="grid w-full grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16">
            <div className="flex flex-col items-center text-center">
              ...
              <p>Capital to fund planting, growth, and harvest cycles.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
                <img
              ...
              <p>Capital to purchase or consolidate agricultural assets.</p>
            </div>
          </div>
          ...
          <div className="grid w-full grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16">
            <div className="flex flex-col items-center text-center">
              ...
              <p>
                Asset-backed capital secured against productive rural property.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
              ...
              <p>
                Short-term capital aligned to operational or commodity timing.
              </p>
            </div>
          </div>
        </div>
