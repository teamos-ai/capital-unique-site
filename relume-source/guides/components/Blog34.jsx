      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="md:text-md">
              Straightforward frameworks designed to help you understand
              structure, risk, and decision-making in non-standard capital
              scenarios.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                Understanding cost beyond interest
              </h2>
            </a>
            <p>
              A practical breakdown of total funding cost, including fees,
              timing, and opportunity trade-offs.
            </p>
            <Button
              title="Download"
              variant="link"
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
                How private investors assess risk
              </h2>
            </a>
            <p>
              A clear framework for evaluating downside, protections, and deal
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <p>
              What information matters, how to present it clearly, and why
              preparation changes outcomes more than rates.
            </p>
            <Button
              title="Download"
              variant="link"
