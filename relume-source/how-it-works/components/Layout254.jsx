        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">
              Capital Unique moves through four deliberate stages, each designed
              to build clarity and confidence before capital deploys.
            </p>
          </div>
        </div>
        <div className="grid place-items-center gap-x-8 gap-y-12 sm:grid-cols-2 md:gap-y-16 lg:grid-cols-[1fr_1.5fr_1fr] lg:gap-x-12">
          <div className="grid w-full grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16">
            <div className="flex flex-col items-center text-center">
              ...
              <p>
                We listen carefully to clarify your unique capital requirements.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
              ...
              <p>
                We analyse the scenario to determine optimal capital structure.
              </p>
            </div>
          </div>
          ...
          <div className="grid w-full grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16">
            <div className="flex flex-col items-center text-center">
              ...
              <p>
                We outline terms and expectations with complete clarity and
                certainty.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p>We execute and manage the capital solution with discipline.</p>
            </div>
          </div>
        </div>
